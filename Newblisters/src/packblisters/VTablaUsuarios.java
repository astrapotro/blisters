...
public class VTablaUsuarios extends JPanel implements ListSelectionListener,
		TableModelListener {
	...
	public VTablaUsuarios() {
		...
		btnModUsuario.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JCheckBox root = new JCheckBox(null, null, usrselected
						.getRoot());
				panel.add(lblPass);
				panel.add(pass);
				panel.add(lblRoot);
		...
		btnBorrarUsuario.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// TODO
				String[] options = new String[] { "OK", "Cancelar" };
				int option = JOptionPane.showOptionDialog(null, "Borrar a "
						+ usrselected.getNombre(), "Borrar usuario",
	...
	public void valueChanged(ListSelectionEvent e) {
		...
		if (filaVista < 0) {
			...
			System.out.println(Messages
					.getString("VTablaUsuarios.ErrorNoSelection")); //$NON-NLS-1$
		} else {
