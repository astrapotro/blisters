				...
				(Principal.d.height / 2) - 150, 250, 347);
		{
			...
			guardar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					medSeleccionado.setCodnac(Integer.valueOf(jtfCodNac
							.getText()));
					medSeleccionado.setCodbar(Long.valueOf(jtfCodBar.getText()));
					medSeleccionado.setIdcorte(Integer
							.valueOf(idModificadoCorte));
					...
					JOptionPane.showMessageDialog(vPadre,
							"Medicamento modificado correctamente", "Info",
